    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-950 px-4">
      ...
      >
        ...
        <h1 className="text-center text-2xl font-bold text-white">
          Sign in to <span className="text-cyan-400">Nexora</span>
        </h1>
        ...
        <div className="mt-8 flex flex-col gap-3">
          <button className="flex items-center justify-center gap-3 rounded-lg border border-gray-700 bg-gray-800 px-4 py-3 text-sm font-medium text-white hover:border-gray-600 hover:bg-gray-750 transition-all duration-200">
